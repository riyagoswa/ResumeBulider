...
client=openai.OpenAI(api_key="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")
...
hobbies = st.text_input("hobbies", placeholder="Enter Some hobbies")
# Section: Skills
st.header("💡 Skills")
...
if st.button("Generate Resume"):
    resume_data = {
        ...
        "hobbies": generate_refined_resume(
            "Create the some hobbies of the resume and make it short, precise and to the point"+ hobbies, job_profile
        ),
    }
    print(resume_data)
